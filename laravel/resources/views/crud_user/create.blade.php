                        ...
                        <div class="card-body">
                            <form action="{{ route('user.postUser') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    @endif
                                    <div class="form-group mb-3">
                                    <label for="Sở thích ">Sở thích</label><br><br>
                                    <input type="text" placeholder="Sở thích" id="sothich_address" class="form-control" name="sothich" required autofocus>
                                    @if ($errors->has('sothich'))
                                        <span class="text">{{ $errors->first('sothich') }}</span>
                                    @endif
                                </div>
                                    <div class="form-group mb-3">
